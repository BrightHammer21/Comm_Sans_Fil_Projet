...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        btn_valider_infos->setGeometry(QRect(434, 270, 75, 23));
        ...
        Nom->setGeometry(QRect(474, 130, 113, 20));
        Prenom = new QLineEdit(Widget);
        Prenom->setObjectName(QString::fromUtf8("Prenom"));
        Prenom->setGeometry(QRect(474, 170, 113, 20));
        ...
        label_5->setGeometry(QRect(380, 215, 61, 41));
        label_5->setFont(font);
        credit = new QLineEdit(Widget);
        credit->setObjectName(QString::fromUtf8("credit"));
        credit->setGeometry(QRect(480, 220, 113, 20));
